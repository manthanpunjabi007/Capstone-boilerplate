...
Local QA branch: `jr/test-login-page-restyle`
...
Note: the first typecheck attempt failed because stale generated `.next/dev/types` referenced the Team page route from the previous branch. Moving the generated `.next` cache out of the repo path and rerunning typecheck passed.
